# Embedded
Репозиторий содержить руководства для работы с различными встраиваемыми системами
...
Руководство и проект для примера находятся в директории CubeMX_VScode
...
## Icarus-Verilog + дополнения VSCode
 ...
 Руководство и проект для примера находятся в директории IcarusVerilog_VScode
...
## Установка Arch Linux на Raspberry Pi
 ...
 Руководство находится в директории Raspberry_Pi_Setup_Guide
